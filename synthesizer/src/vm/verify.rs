            ...
            Transaction::Deploy(id, deployment_id, owner, deployment, _) => {
                ...
                match consensus_version >= ConsensusVersion::V8 {
                    ...
                    false => {
                            ...
                            !deployment.program().contains_v8_syntax(),
                ...
                //    This is to prevent programs deployed before `ConsensusVersion::V8` (which do not have constructors) from being upgraded.
