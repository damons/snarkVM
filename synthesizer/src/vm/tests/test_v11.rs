...
fn test_ecdsa_keccak256_eth() {
    // Get the addresses.
    let valid_address = "0x589d3e40069df16c429522acab02c9dafd955833";
    let inval_address = "0x589d3e40069df16c429522acab02c9dafd955834"; // last byte changed from 3 to 4

    // Define the valid test vectors.
    // Each test vector is a tuple of (message, message_hash, signature).
    let valid_test_vectors = vec![
        (
            ...
            "0x9d2aada38011b3543e73ac301eaa6a51b0a7bc9fa5df0dcd297b91602d7c425d5196639368a4dae405b46c3aa015c7551ae7af01bc7570069dde7d4035e54d1d1b",
        ),
        (
            ...
            "0xc573ff15d2febbbab9842fc55fc887f6353aef1caf28b8f77bb071c9a4f005685d4603939860d7ee00a3c3ec87daf1081e0c908e208391fbf3ed061f61a5dccf1b",
        ),
        (
            ...
            "0x6fdc181e445ececf005310bdca2aa9e8a3b79a2f2a89ea898dd46cbb129ec59f5e051b496e3ce942f8cdb973bb9c5adc3247438022c8b0f1b593bd5f09bb90ea1c",
        ),
        (
            ...
            "0x8fa4811e12534a6feb1c81272aa3e2b1c7fa77b179ff52ccc8982efaf8546742431d6bf26ca99ee6b3a82e6eb74b972ca4adda9b11a084fee754329999ffc6761b",
        ),
        (
            ...
            "0xc516d75d1dc1b564e0e53413dbe516eec202666473a17fe5dae9201e485896e0012d25e41a15661a9ae5127b71c4d3b6b06fd7e0c820e43805c45dbb691ec3f81b",
        ),
    ];

    // Define the invalid test vectors.
    // Each test vector is a tuple of (message, signature).
    let invalid_test_vectors = vec![
        (
            ...
            "0x394cedb62ec18360797c4fa46cde4ccc7838e50b9039586def69ebe2499ffcf30da0aea134b1fb20f57a6e50db3892dfef487abfbee56bc92d07852f2e99cc331c",
        ),
        (
            ...
            "0xd18bdcf1c33c16a3e6d21ca66f7f5a238d6eb7e4750cfff36f34788db317285c00194c711d4f33812ecb72a5bc13c24c33e48b6e7c57690408eae13e5c8197511c",
        ),
        (
            ...
            "0xad605014dc973727fb4d15027a071d883550172a7f10b1ee637460a836190b5f46f32c2fc8b5f41d6d5c42a3ad6d6a1a1c854c5257fb74f878b2e624af03566b1b",
        ),
        (
            ...
            "0x410abc6b68308d891a517813043adc80150e956212cb9a176db2e1194e133e330e89421cecce573d2aa15a90557f48b0248f055f6c1c457ce43afa8ebf0ddb5a1b",
        ),
        (
            ...
            "0xddcf4943f37197ed5d6751673749dd4bd1e7423499ab94af5a3db420704238080248964ab48cfbff919ffec1901e04c53392c545e23718813cdb3b333af061941b",
        ),
        (
            ...
            "0xd4d384470339372c22ec5b69666679215d0f7ceca293091dae6d8d9d3a4dd1bd617992b95336ecca97c899aef31389955d9c02722dc46de433702f567b7885a51c",
        ),
    ];
...
constructor:
    ...
    //  - check that the message and hash are equal.
    //  - check that the signature verification behaves as expected.
    for (message, hash, signature) in &valid_test_vectors {
        // Parse the inputs.
    ...
    for (message, signature) in &invalid_test_vectors {
        // Parse the inputs.
        let message_plaintext = parse_hex_to_plaintext(message);
        let signature_plaintext = parse_hex_to_plaintext(signature);
