...
name: snarkvm-github
description: |
  Fetch GitHub context (PR or issue) into workspace for snarkVM development.
...
- **snarkvm-review** — Security-focused PR review
- **snarkvm-fix-pr** — Fix PR review feedback
- **snarkvm-fix** — Fix GitHub issues
