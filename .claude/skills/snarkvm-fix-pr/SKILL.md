...
name: snarkvm-fix-pr
description: |
  Fix PR review feedback in snarkVM using TDD workflow.
  ...
  WHEN NOT: Creating new fixes for issues (use snarkvm-fix), doing security 
  review (use snarkvm-review), or initial PR creation.
allowed-tools: Bash, Read, Write, Grep, Glob, Task, AskUserQuestion
---

# Fix PR Review Feedback

Address PR review comments in snarkVM using test-driven development.

## Usage

```
/snarkvm-fix-pr <pr_number>
```
...
- **High** — Core logic, consensus-critical, crypto
